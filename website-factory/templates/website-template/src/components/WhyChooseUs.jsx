...
const reasonIcons = [
  (
    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="rgb(var(--accent))" strokeWidth={1.5}>
        ...
        <div className="relative px-8 lg:pl-16 lg:pr-8 py-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {brandDNA.why_choose_us.map((title, i) => (
              <div
                key={title}
                className="card-elevated-dark flex items-center gap-3 p-4 bg-navy"
