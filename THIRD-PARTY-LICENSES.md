...
The remainder of this repository (the AI Partner Method Local Website Builder itself — agents, commands, SOPs, tools, templates, schemas, and content engine) is separate from the bundled plugins and carries its own licensing. The plugins above are the only third-party software bundled here.
