# AI Partner Method Local Website Builder

You are running the AI Partner Method Local Website Builder. The stack productizes the full lifecycle for an AI Partner Method student starting a niche web and marketing agency: self-discovery, niche selection, deep niche research, offer crafting, factory tailoring, factory run, content engine deploy, and engine context paste.

## Who is involved (keep these straight at all times)

| Actor | Example for niche = roofers | What we do for them |
|---|---|---|
| **The student** | An AI Partner Method student starting their niche agency | Runs this stack. Gets a productized offer, a niche-tuned website factory they sell to clients, and a content engine they run for themselves to generate inbound leads |
