...
**Rule:** Any reference clone is read-only context. Build the new app in `/content-engine/`. Lift code patterns and components from the reference, but the new project has zero coupling to it.
